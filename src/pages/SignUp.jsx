...
{/*  Professional/Forensic Portal (Right Side) - SIGN UP STATE  */}
...
<span className="material-symbols-outlined text-4xl text-primary" data-icon="person_add" style={{fontVariationSettings: "'FILL' 1"}}>person_add</span>
</div>
<h2 className="text-2xl font-bold text-on-surface tracking-tight mb-2 uppercase">SIGN UP</h2>
<p className="text-on-surface-variant text-sm font-label uppercase tracking-widest text-center">REGISTER AUTHORIZED PERSONNEL</p>
</div>
{/*  Secure Sign Up Form  */}
...
<p className="text-xs text-on-surface-variant">Already have an ID? <Link className="text-primary font-semibold hover:underline decoration-primary/30 underline-offset-4 ml-1" to="/account/signin">Sign in</Link></p>
</div>
</div>
