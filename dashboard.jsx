...
<div className="text-xl font-bold tracking-tighter text-[#db90ff] font-['Space_Grotesk']" style={{}}>Vision Trace</div>
...
<a className="flex items-center gap-3 px-4 py-3 rounded-xl text-on-surface-variant hover:text-on-surface hover:bg-white/5 hover:backdrop-blur-md transition-all duration-300 ease-in-out font-headline font-semibold tracking-wide" href="#" style={{}}>
<span className="material-symbols-outlined" data-icon="folder_open" style={{}}>folder_open</span>
<span className="" style={{}}>Evidence</span>
</a>
<a className="flex items-center gap-3 px-4 py-3 rounded-xl text-primary bg-primary/10 border-r-2 border-primary transition-all duration-300 ease-in-out font-headline font-semibold tracking-wide" href="#" style={{}}>
...
<a className="flex items-center gap-3 px-4 py-3 rounded-xl text-on-surface-variant hover:text-on-surface hover:bg-white/5 transition-all duration-300 font-headline font-semibold tracking-wide" href="#" style={{}}>
...
<div className="glass-card p-4 rounded-xl bloom-primary flex items-center gap-4">
...
{/* High Risk Card 1 */}
<div className="glass-card rounded-xl overflow-hidden border-error/30 relative">
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
<div className="glass-card rounded-xl overflow-hidden border-tertiary-container/20">
<div className="relative aspect-video">
...
{/* Analytics Panel */}
<div className="glass-card rounded-2xl p-6 border-primary/40 relative">
...
</div><div className="glass-card rounded-2xl p-6 relative overflow-hidden">
...
<path className="text-error" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="currentColor" strokeDasharray="25, 100" strokeLinecap="round" strokeWidth="3" /></path>
<path className="text-tertiary-container" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="currentColor" strokeDasharray="35, 100" strokeDashoffset="-25" strokeLinecap="round" strokeWidth="3" /></path>
<path className="text-primary" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="currentColor" strokeDasharray="40, 100" strokeDashoffset="-60" strokeLinecap="round" strokeWidth="3" /></path>
</svg>
...
<div className="flex items-center gap-2" style={{}}><span className="w-2 h-2 rounded-full bg-error"></span> High Risk</div>
<div className="font-bold" style={{}}>25%</div>
</div>
<div className="flex items-center justify-between text-xs">
<div className="flex items-center gap-2" style={{}}><span className="w-2 h-2 rounded-full bg-tertiary-container"></span> Low Risk</div>
<div className="font-bold" style={{}}>35%</div>
</div>
<div className="flex items-center justify-between text-xs">
<div className="flex items-center gap-2" style={{}}><span className="w-2 h-2 rounded-full bg-primary"></span> No Risk</div>
<div className="font-bold" style={{}}>40%</div>
</div>
</div>
</div>
